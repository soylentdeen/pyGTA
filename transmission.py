...
from testing_modes import TransmissionEfficiency
...
transmission_efficiency = TransmissionEfficiency(inst, parameters)
transmission_efficiency.setup()
transmission_efficiency.run(files)

inst.motor.goto(0.0)
final = inst.srs.measure_const_SNR(10)
